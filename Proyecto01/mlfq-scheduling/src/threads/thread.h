...
/*Limit values for niceness.*/
/*new change*/
#define NICE_MAX 20                     /* Lowest niceness. */
#define NICE_DEFAULT 0                  /* Default nice. */
#define NICE_MIN -20                    /* Highest niceness. */
/*new change*/
...
struct thread
  {
   ...
   /*we go back the previous change*/
	...
	int nice;                           /* Determines how nice a thread should
	                                       be to other threads. */
	fixpoint_t recent_cpu;                 /* The recent cpu. */
  };
...
/*new change*/
/*funtion to compare the priority of two threads*/
bool compare_threads_by_priority (const struct list_elem *,
                                  const struct list_elem *,
                                  void *);
/*update the priority*/
void thread_update_priority (struct thread *);
/*rearrange the ready list*/
