...
/*Declaration of function that compares threads according to their sleep times*/
bool sleeptime_comparator(struct list_elem *a, struct list_elem *b, void *aux);
/*Declaration of function that compares threads according to their priority*/
bool priority_comparator(struct list_elem *a, struct list_elem *b, void *aux);
/*Declaration of function that compares threads according to their priority but in reverse order*/
